...
class LinkList{
	...
	public void insertFirstLink(Item i){
		Item newItem = i;
		
		ShoppingList newLink = new ShoppingList(newItem);
	...
	public ShoppingList removeFirst(){
		
		ShoppingList linkReference = firstLink;
	...
	/*public void display(){
		...
		ShoppingList theLink = firstLink;
	...
	public ShoppingList find(Item i){
		
		ShoppingList theLink = firstLink;
		
		if(!isEmpty()){
		
			while(theLink.name != i.getName()){
	...
	public ShoppingList removeLink(Item i){
		
		ShoppingList currentLink = firstLink;
		ShoppingList previousLink = firstLink;
		
		// Keep searching as long as a match isn't made
		
		while(currentLink.name != i.getName()){
